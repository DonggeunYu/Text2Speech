...
def main():
	...
	parser.add_argument('--tacotron_train_steps', type=int, default=10000, help='total number of tacotron training steps')
	parser.add_argument('--wavenet_train_steps', type=int, default=10000, help='total number of wavenet training steps')
